...
class VoronoiVisualizer(Node):
    def __init__(self):
        ...
        # Subscribe to your custom graph with increased queue depth
        self.sub = self.create_subscription(Graph, '/voronoi_graph', self.graph_callback, map_qos)
        # Publish RViz markers with increased queue depth
    ...
    def graph_callback(self, msg):
        ...
        edge_marker.scale.x = 0.2 # Line thickness (2cm)
        ...
        for edge in msg.edges:
            ...
            p1 = Point(x=start_node.x, y=start_node.y, z=0.01)
            p2 = Point(x=end_node.x, y=end_node.y, z=0.01)
        ...
        node_marker.scale.x = 0.5 # Point size (5cm)
